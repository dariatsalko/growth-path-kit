  ...
  const detailedPractices = [
    {
      ...
      howTo: "На 3-5 минут полностью сосредоточьтесь на естественном ритме своего дыхания. Когда внимание уплывает, мягко, без критики, верните его к вдохам и выдохам.",
      purpose: "Якорение в настоящем: помогает выйти из потока мыслей о прошлом или будущем. Снижение тревоги: успокаивает нервную систему через концентрацию. Остановка «мысленной жвачки»: прерывает цикл навязчивых размышлений.",
      instructions: [
    ...
    },
    {
      ...
      howTo: "Мысленное путешествие вниманием по всему телу от макушки до кончиков пальцев ног. Цель — замечать ощущения (тепло, тяжесть, покалывание, напряжение) без попытки их изменить.",
      purpose: "Снятие телесных зажимов: повышает осознанность и помогает расслабить напряженные участки. Снижение стресса: переводит фокус с тревожных мыслей на физические ощущения. Восстановление связи с телом: учит слышать сигналы и потребности организма.",
      instructions: [
    ...
    },
    {
      ...
      howTo: "Прием пищи без внешних раздражителей (телефон, TV), с полным вниманием к процессу: к текстуре, вкусу, запаху и ощущениям от еды.",
      purpose: "Восстановление контакта с ощущениями: помогает распознавать настоящий голод и насыщение. Улучшение пищевого поведения: способствует лучшему пищеварению и получению большего удовлетворения от еды. Полнота опыта: превращает прием пищи из автоматического процесса в осознанный ритуал.",
      instructions: [
    ...
    },
    {
      ...
      howTo: "Ходьба, при которой все внимание направлено на физические ощущения от движения: на то, как стопы касаются земли, работают мышцы ног и тела.",
      purpose: "Заземление: помогает вернуться в «здесь и сейчас», особенно при тревоге. Успокоение ума: ритмичное движение и концентрация на ощущениях действуют медитативно. Интеграция в рутину: эту практику легко применять в повседневной жизни по дороге на работу или домой.",
      instructions: [
    ...
    {
      name: "Техника «СТОП»",
      howTo: "Краткий алгоритм для паузы в момент нарастания стресса. Не требует уединения и может быть применен где угодно.",
      purpose: "Экстренная самопомощь: быстрое переключение из реактивного режима в режим наблюдения. Управление реакциями: помогает не поддаться первой импульсивной реакции и действовать осознанно. Возвращение в равновесие: позволяет «передохнуть» и восстановить контакт с текущим моментом.",
      instructions: [
                              ...
                              <div className="p-4 bg-secondary/50 rounded-lg">
                                ...
                                <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                                  {practice.instructions?.map((instruction, idx) => (
                                    ...
                                    <li key="default">Найдите удобное место, где вас никто не потревожит</li>,
                                    <li key="default2">Примите комфортную позу (сидя или лежа)</li>,
                                    <li key="default3">Закройте глаза или смотрите в одну точку</li>,
                                    <li key="default4">{practice.howTo}</li>,
                                    <li key="default5">Начните с 5-10 минут, постепенно увеличивая время</li>,
                                    <li key="default6">Завершите практику медленно, открыв глаза</li>
                                  ]}
                                </ol>
                              </div>
                              <div className="p-4 bg-accent/10 rounded-lg">
                                ...
                                <ul className="space-y-1 text-sm text-muted-foreground list-disc list-inside">
                                  {practice.recommendations?.map((rec, idx) => (
                                    ...
                                    <li key="rec1">Практикуйте в одно и то же время каждый день</li>,
                                    <li key="rec2">Не судите себя за "блуждающие" мысли - это нормально</li>,
                                    <li key="rec3">Будьте терпеливы - результаты приходят с постоянством</li>
                                  ]}
                                </ul>
                              </div>
