...
const PsychologistsSection = ({ onSelectPsychologist }: PsychologistsSectionProps) => {
  ...
  const psychologists = [{
    ...
    approach: ["КПТ", "Семейная терапия", "Кризисная психология", "ЭИ", "Mindfulness"],
    experience: "Индивидуальное консультирование, семейная терапия, групповые тренинги, мотивационный коучинг",
    education: "АНО ДПО «Институт прикладной психологии в социальной сфере», Москва",
    available: true,
