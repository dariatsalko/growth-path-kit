...
const BookingModal = ({
  ...
  const [formData, setFormData] = useState(() =>
    getInitialFormData(selectedPsychologist || "")
  );
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "openBookingWithPsychologist",
      handleBookingWithPsychologist as EventListener
    );
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.agreements.privacy || !formData.agreements.terms) {
      toast({
        title: "Ошибка",
        description:
          "Необходимо согласие с политикой конфиденциальности и офертой",
        variant: "destructive",
      });
      return;
    }
    ...
    >
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Заполните форму, и мы свяжемся с вами в течение 2 часов для
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="Екатерина Иванова">
                  Екатерина Иванова
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData({ ...formData, timePreference: value })
              }
            >
              <SelectTrigger>
          ...
          <div className="pt-4">
            ...
            <p className="text-center text-sm text-muted-foreground mt-3">
              Мы свяжемся с вами в течение 2 часов для согласования времени и
              деталей
            </p>
          </div>
        </form>
